...
const CardDetails = () => {
  return (
    <div className="text-left">
      ...
      <ul className="list-disc px-10 fill-[#8F19E8]">
        ...
        <li className="text-[#2D2D2D] md:text-[1.125rem] text-base leading-[24px] font-normal mt-5">A component of many instruments including the piano, organ, and harpsichord consisting of usually black and white keys that cause different tones to be produced when struck.</li>
        <li className="text-[#2D2D2D] md:text-[1.125rem] text-base leading-[24px] font-normal mt-5">A device with keys of a musical keyboard, used to control electronic sound-producing devices which may be built into or separate from the keyboard device.</li>
      </ul>
      ...
      <div>
      <p className="text-[#2D2D2D] md:text-[1.5rem] text-[1.125rem] font-bold italic mt-[2.5rem]">verb</p>
      <p className="text-[#757575] md:text-[1.25rem] text-base font-normal mt-[2.5rem]">Meaning</p>
      <ul className=" ml-10 fill-[#8F19E8]">
        <li className="list-disc text-[#2D2D2D] md:text-[1.125rem] text-base leading-[24px] font-normal mt-[2.5rem]">To type on a computer keyboard.</li>
